...
// Builds and animates the exploded-view steel tank tied to scroll position
// inside `stageRef`, rendering into `wrapRef`. Ported 1:1 from the original
// vanilla-JS scroll story, just wired up through refs instead of getElementById.
export function useTankScene(stageRef, wrapRef) {
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener('scroll', readS)
